# 🔍 Grid Island - 실제 GPS & 센서 기반 휠체어 친화 경로찾기 시스템

**실제 SensorLog 데이터를 활용한 휠체어 사용자 맞춤 최적 경로 탐색**

## 🎯 시스템 개요

실제 SensorLog 앱에서 수집한 GPS와 센서 데이터를 활용하여 휠체어 사용자를 위한 최적 경로를 탐색하는 통합 시스템입니다. IMU 센서 데이터에서 이동 난이도를 분석하고, GPS 경로와 결합하여 실용적인 경로찾기 솔루션을 제공합니다.
